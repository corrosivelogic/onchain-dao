...
import React11, { createContext as createContext5, useContext as useContext4, useEffect as useEffect6, useState as useState4 } from "react";
...
// src/transactions/TransactionStoreContext.tsx
var storeSingleton;
var TransactionStoreContext = createContext5(null);
function TransactionStoreProvider({
  ...
  const [store] = useState4(() => storeSingleton != null ? storeSingleton : storeSingleton = createTransactionStore({ provider }));
  useEffect6(() => {
  ...
  return /* @__PURE__ */ React11.createElement(TransactionStoreContext.Provider, {
    value: store
  }, children);
}
...
function useRecentTransactions() {
  ...
  const chainId = useChainId();
  const [transactions, setTransactions] = useState5(() => store && address && chainId ? store.getTransactions(address, chainId) : []);
  useEffect7(() => {
...
import { useAccount as useAccount9, useBalance, useDisconnect } from "wagmi";
...
import React22, { createContext as createContext11, useContext as useContext7 } from "react";
...
import React14, { createContext as createContext9, useContext as useContext5 } from "react";
...
import React13, { createContext as createContext8, useMemo as useMemo6, useState as useState7 } from "react";
...
function WalletButtonProvider({ children }) {
  const [connector, setConnector] = useState7(null);
  return /* @__PURE__ */ React13.createElement(WalletButtonContext.Provider, {
    value: useMemo6(() => ({
      connector,
      setConnector
    }), [connector])
...
var ModalSizeContext = createContext9(ModalSizeOptions.WIDE);
function ModalSizeProvider({
  ...
  return /* @__PURE__ */ React14.createElement(ModalSizeContext.Provider, {
...
function useFingerprint() {
  const fingerprint = useCallback3(() => {
    setRainbowKitVersion({ version: "1.3.2" });
  }, []);
  useEffect9(() => {
    fingerprint();
  }, [fingerprint]);
...
function getBrowser() {
  ...
  if ((_a = navigator.brave) == null ? void 0 : _a.isBrave)
    return "Brave" /* Brave */;
  else if (ua2.indexOf("edg/") > -1)
    return "Edge" /* Edge */;
  else if (ua2.indexOf("op") > -1)
    return "Opera" /* Opera */;
  else if (isArc())
    return "Arc" /* Arc */;
...
var AssetsIcon = () => /* @__PURE__ */ React15.createElement(AsyncImage, {
  background: "#d0d5de",
  borderRadius: "10",
  height: "48",
  src,
...
var LoginIcon = () => /* @__PURE__ */ React16.createElement(AsyncImage, {
  background: "#d0d5de",
  borderRadius: "10",
  height: "48",
  src: src2,
...
import React21, { useCallback as useCallback4, useContext as useContext6, useRef as useRef2 } from "react";
...
var CloseIcon = () => {
  return isMobile() ? /* @__PURE__ */ React19.createElement("svg", {
    "aria-hidden": true,
    fill: "none",
    height: "11.5",
...
var CloseButton = ({
  ...
  return /* @__PURE__ */ React20.createElement(Box, {
    ...
    type: "button",
    width: mobile ? "30" : "28"
  }, /* @__PURE__ */ React20.createElement(CloseIcon, null));
};
...
function SignIn({ onClose }) {
  ...
  const [{ status, ...state }, setState] = React21.useState({ status: "idle" });
  ...
  return /* @__PURE__ */ React21.createElement(Box, {
    ...
    position: "absolute",
    right: "0"
  }, /* @__PURE__ */ React21.createElement(CloseButton, {
    onClose
  })), /* @__PURE__ */ React21.createElement(Box, {
    alignItems: "center",
    display: "flex",
    ...
    flexDirection: "column",
    gap: mobile ? "32" : "16"
  }, /* @__PURE__ */ React21.createElement(AsyncImage, {
    height: 40,
    src: signInIcon,
    width: 40
    ...
    textAlign: "center",
    weight: "heavy"
  }, i18n2.t("sign_in.label"))), /* @__PURE__ */ React21.createElement(Box, {
    alignItems: "center",
    display: "flex",
    flexDirection: "column",
    gap: mobile ? "16" : "12"
    ...
    size: mobile ? "16" : "14",
    textAlign: "center"
  }, i18n2.t("sign_in.description")), status === "idle" && state.errorMessage ? /* @__PURE__ */ React21.createElement(Text, {
    color: "error",
    size: mobile ? "16" : "14",
    textAlign: "center",
    weight: "bold"
  }, state.errorMessage) : null)), /* @__PURE__ */ React21.createElement(Box, {
    alignItems: !mobile ? "center" : void 0,
    display: "flex",
    flexDirection: "column",
    gap: "8",
    width: "full"
  }, /* @__PURE__ */ React21.createElement(ActionButton, {
  ...
  }), mobile ? /* @__PURE__ */ React21.createElement(ActionButton, {
    label: "Cancel",
    onClick: onClose,
    size: "large",
    type: "secondary"
...
function RainbowKitProvider({
  ...
  return /* @__PURE__ */ React22.createElement(RainbowKitChainProvider, {
    chains,
    initialChain
  }, /* @__PURE__ */ React22.createElement(WalletButtonProvider, null, /* @__PURE__ */ React22.createElement(I18nProvider, {
    locale
  }, /* @__PURE__ */ React22.createElement(CoolModeContext.Provider, {
    value: coolMode
  }, /* @__PURE__ */ React22.createElement(ModalSizeProvider, {
    modalSize
  }, /* @__PURE__ */ React22.createElement(ShowRecentTransactionsContext.Provider, {
    value: showRecentTransactions
  }, /* @__PURE__ */ React22.createElement(TransactionStoreProvider, null, /* @__PURE__ */ React22.createElement(AvatarContext.Provider, {
    value: avatarContext
  }, /* @__PURE__ */ React22.createElement(AppContext.Provider, {
    value: appContext
  }, /* @__PURE__ */ React22.createElement(ThemeIdContext.Provider, {
    value: id
  }, /* @__PURE__ */ React22.createElement(ModalProvider, null, theme ? /* @__PURE__ */ React22.createElement("div", {
    ...createThemeRootProps(id)
  }, /* @__PURE__ */ React22.createElement("style", {
...
import React23, { useCallback as useCallback6, useEffect as useEffect11, useRef as useRef3 } from "react";
...
function Dialog({ children, onClose, open, titleId }) {
  ...
  const [bodyScrollable, setBodyScrollable] = useState8(true);
  useEffect12(() => {
  ...
  const mobile = isMobile();
  return /* @__PURE__ */ React24.createElement(React24.Fragment, null, open ? createPortal(/* @__PURE__ */ React24.createElement(RemoveScroll, {
    ...
    position: "fixed",
    role: "dialog"
  }, /* @__PURE__ */ React24.createElement(FocusTrap, {
    className: content,
...
import React25, { useContext as useContext8 } from "react";
...
import React35, { useCallback as useCallback9, useContext as useContext10, useEffect as useEffect13, useState as useState9 } from "react";
...
var CopiedIcon = () => /* @__PURE__ */ React26.createElement("svg", {
  fill: "none",
  height: "13",
  viewBox: "0 0 13 13",
  width: "13",
...
var CopyIcon = () => /* @__PURE__ */ React27.createElement("svg", {
  fill: "none",
  height: "16",
  viewBox: "0 0 17 16",
  width: "17",
...
var DisconnectIcon = () => /* @__PURE__ */ React28.createElement("svg", {
  fill: "none",
  height: "16",
  viewBox: "0 0 18 16",
  width: "18",
...
var ExternalLinkIcon = () => /* @__PURE__ */ React29.createElement("svg", {
  fill: "none",
  height: "19",
  viewBox: "0 0 20 19",
  width: "20",
...
var CancelIcon = () => /* @__PURE__ */ React30.createElement("svg", {
  fill: "none",
  height: "19",
  viewBox: "0 0 20 19",
  width: "20",
...
var SuccessIcon = () => /* @__PURE__ */ React31.createElement("svg", {
  fill: "none",
  height: "20",
  viewBox: "0 0 20 20",
  width: "20",
...
function TxItem({ tx }) {
  ...
  return /* @__PURE__ */ React32.createElement(React32.Fragment, null, /* @__PURE__ */ React32.createElement(Box, {
    ...
    color
  }, /* @__PURE__ */ React32.createElement(Icon, null)), /* @__PURE__ */ React32.createElement(Box, {
    display: "flex",
    flexDirection: "column",
    gap: mobile ? "3" : "1"
  }, /* @__PURE__ */ React32.createElement(Box, null, /* @__PURE__ */ React32.createElement(Text, {
    color: "modalText",
    font: "body",
    size: mobile ? "16" : "14",
    weight: "bold"
  }, tx == null ? void 0 : tx.description)), /* @__PURE__ */ React32.createElement(Box, null, /* @__PURE__ */ React32.createElement(Text, {
    color: tx.status === "pending" ? "modalTextSecondary" : color,
    font: "body",
    size: "14",
    weight: mobile ? "medium" : "regular"
  }, confirmationStatus)))), explorerLink && /* @__PURE__ */ React32.createElement(Box, {
    alignItems: "center",
    color: "modalTextDim",
    display: "flex"
...
function TxList({ address }) {
  ...
  return /* @__PURE__ */ React33.createElement(React33.Fragment, null, /* @__PURE__ */ React33.createElement(Box, {
  ...
  }, hasTransactions && /* @__PURE__ */ React33.createElement(Box, {
    ...
    size: mobile ? "16" : "14",
    weight: "semibold"
  }, i18n2.t("profile.transactions.recent.title")), /* @__PURE__ */ React33.createElement(Box, {
    style: {
      marginBottom: -6,
      marginLeft: -10,
      marginRight: -10,
    ...
    size: mobile ? "16" : "14",
    weight: "semibold"
  }, i18n2.t("profile.transactions.clear.label")))))), /* @__PURE__ */ React33.createElement(Box, {
    display: "flex",
    flexDirection: "column",
    gap: "4"
  }, hasTransactions ? visibleTxs.map((tx) => /* @__PURE__ */ React33.createElement(TxItem, {
    key: tx.hash,
    tx
  })) : /* @__PURE__ */ React33.createElement(React33.Fragment, null, /* @__PURE__ */ React33.createElement(Box, {
    padding: mobile ? "12" : "8"
  }, /* @__PURE__ */ React33.createElement(Text, {
    color: "modalTextDim",
    size: mobile ? "16" : "14",
    ...
    appName
  }) : i18n2.t("profile.transactions.description_fallback"))), mobile && /* @__PURE__ */ React33.createElement(Box, {
    background: "generalBorderDim",
    height: "1",
    marginX: "12",
    marginY: "8"
  })))), explorerLink && /* @__PURE__ */ React33.createElement(Box, {
    paddingBottom: "18",
    paddingX: mobile ? "8" : "18"
  }, /* @__PURE__ */ React33.createElement(Box, {
    alignItems: "center",
  ...
  }, i18n2.t("profile.explorer.label")), /* @__PURE__ */ React33.createElement(ExternalLinkIcon, null))));
}
...
function ProfileDetailsAction({
  ...
  return /* @__PURE__ */ React34.createElement(Box, {
    ...
    color: "modalText",
    height: "max"
  }, icon), /* @__PURE__ */ React34.createElement(Box, null, /* @__PURE__ */ React34.createElement(Text, {
    color: "modalText",
    size: mobile ? "12" : "13",
    weight: "semibold"
  }, label))));
...
function ProfileDetails({
  ...
  const [copiedAddress, setCopiedAddress] = useState9(false);
  ...
  return /* @__PURE__ */ React35.createElement(React35.Fragment, null, /* @__PURE__ */ React35.createElement(Box, {
  ...
  }, /* @__PURE__ */ React35.createElement(Avatar, {
    address,
    imageUrl: ensAvatar,
    size: mobile ? 82 : 74
  })), /* @__PURE__ */ React35.createElement(Box, {
    ...
    size: mobile ? "20" : "18",
    weight: "heavy"
  }, accountName)), balanceData && /* @__PURE__ */ React35.createElement(Box, {
    textAlign: "center"
  }, /* @__PURE__ */ React35.createElement(Text, {
    as: "h1",
    color: "modalTextSecondary",
    ...
    size: mobile ? "16" : "14",
    weight: "semibold"
  }, displayBalance, " ", balanceData.symbol)))), /* @__PURE__ */ React35.createElement(Box, {
    display: "flex",
    flexDirection: "row",
    gap: "8",
    margin: "2",
    marginTop: "16"
  }, /* @__PURE__ */ React35.createElement(ProfileDetailsAction, {
    action: copyAddressAction,
    icon: copiedAddress ? /* @__PURE__ */ React35.createElement(CopiedIcon, null) : /* @__PURE__ */ React35.createElement(CopyIcon, null),
    label: copiedAddress ? i18n2.t("profile.copy_address.copied") : i18n2.t("profile.copy_address.label")
  }), /* @__PURE__ */ React35.createElement(ProfileDetailsAction, {
    action: onDisconnect,
    icon: /* @__PURE__ */ React35.createElement(DisconnectIcon, null),
    label: i18n2.t("profile.disconnect.label"),
    testId: "disconnect-button"
  }))), showRecentTransactions && /* @__PURE__ */ React35.createElement(React35.Fragment, null, /* @__PURE__ */ React35.createElement(Box, {
    background: "generalBorder",
    height: "1",
    marginTop: "-1"
  }), /* @__PURE__ */ React35.createElement(Box, null, /* @__PURE__ */ React35.createElement(TxList, {
    address
  })))));
}
...
function AccountModal({ onClose, open }) {
  ...
  return /* @__PURE__ */ React36.createElement(React36.Fragment, null, address && /* @__PURE__ */ React36.createElement(Dialog, {
    onClose,
    open,
    titleId
    ...
    padding: "0"
  }, /* @__PURE__ */ React36.createElement(ProfileDetails, {
    address,
    balanceData,
    ensAvatar,
    ensName,
...
import React39, { Fragment, useContext as useContext11 } from "react";
...
var DisconnectSqIcon = ({ size }) => /* @__PURE__ */ React37.createElement("svg", {
  fill: "none",
  height: size,
  viewBox: "0 0 28 28",
  width: size,
...
// src/components/MenuButton/MenuButton.tsx
var MenuButton = React38.forwardRef(({
  children,
...
function ChainModal({ onClose, open }) {
  ...
  return /* @__PURE__ */ React39.createElement(Dialog, {
    onClose,
    open,
    titleId
  }, /* @__PURE__ */ React39.createElement(DialogContent, {
    bottomSheetOnMobile: true,
    paddingBottom: "0"
    ...
    flexDirection: "row",
    justifyContent: "space-between"
  }, mobile && /* @__PURE__ */ React39.createElement(Box, {
    width: "30"
  }), /* @__PURE__ */ React39.createElement(Box, {
    paddingBottom: "0",
    paddingLeft: "8",
    ...
    size: mobile ? "20" : "18",
    weight: "heavy"
  }, i18n2.t("chains.title"))), /* @__PURE__ */ React39.createElement(CloseButton, {
    onClose
  })), unsupportedChain && /* @__PURE__ */ React39.createElement(Box, {
    marginX: "8",
    ...
    size: "14",
    weight: "medium"
  }, i18n2.t("chains.wrong_network"))), /* @__PURE__ */ React39.createElement(Box, {
    ...
    return /* @__PURE__ */ React39.createElement(Fragment, {
      key: chain.id
    }, /* @__PURE__ */ React39.createElement(MenuButton, {
    ...
    }, iconUrl && /* @__PURE__ */ React39.createElement(Box, {
      height: "full",
      marginRight: "8"
    ...
    })), /* @__PURE__ */ React39.createElement("div", null, name != null ? name : chain.name)), isCurrentChain && /* @__PURE__ */ React39.createElement(Box, {
      alignItems: "center",
      display: "flex",
      flexDirection: "row",
      marginRight: "6"
      ...
      size: "14",
      weight: "medium"
    }, i18n2.t("chains.connected")), /* @__PURE__ */ React39.createElement(Box, {
      ...
      marginLeft: "8",
      width: "8"
    })), switching && /* @__PURE__ */ React39.createElement(Box, {
      alignItems: "center",
      display: "flex",
      flexDirection: "row",
      marginRight: "6"
      ...
      size: "14",
      weight: "medium"
    }, i18n2.t("chains.confirm")), /* @__PURE__ */ React39.createElement(Box, {
      background: "standby",
      borderRadius: "full",
      height: "8",
      marginLeft: "8",
      width: "8"
    }))))), mobile && idx < rainbowkitChains.length - 1 && /* @__PURE__ */ React39.createElement(Box, {
      background: "generalBorderDim",
      height: "1",
      marginX: "8"
    }));
    ...
    appName
  }) : i18n2.t("chains.switching_not_supported_fallback"))), unsupportedChain && /* @__PURE__ */ React39.createElement(React39.Fragment, null, /* @__PURE__ */ React39.createElement(Box, {
    background: "generalBorderDim",
    height: "1",
    marginX: "8"
  }), /* @__PURE__ */ React39.createElement(MenuButton, {
    ...
    justifyContent: "center",
    marginRight: "8"
  }, /* @__PURE__ */ React39.createElement(DisconnectSqIcon, {
...
import { useAccount as useAccount10, useDisconnect as useDisconnect3 } from "wagmi";
...
import React42, { useContext as useContext12 } from "react";
...
function ConnectModalIntro({
  ...
  return /* @__PURE__ */ React42.createElement(React42.Fragment, null, /* @__PURE__ */ React42.createElement(Box, {
    alignItems: "center",
    color: "accentColor",
    display: "flex",
    flexDirection: "column",
    ...
    marginBottom: "10"
  }, !compactModeEnabled && /* @__PURE__ */ React42.createElement(Text, {
    color: "modalText",
    size: "18",
    weight: "heavy"
  }, i18n2.t("intro.title"))), /* @__PURE__ */ React42.createElement(Box, {
    display: "flex",
    flexDirection: "column",
    gap: "32",
    justifyContent: "center",
    ...
    minWidth: "48",
    width: "48"
  }, /* @__PURE__ */ React42.createElement(AssetsIcon, null)), /* @__PURE__ */ React42.createElement(Box, {
    display: "flex",
    flexDirection: "column",
    gap: "4"
    ...
    size: "14",
    weight: "bold"
  }, i18n2.t("intro.digital_asset.title")), /* @__PURE__ */ React42.createElement(Text, {
    color: "modalTextSecondary",
    size: "14",
    weight: "medium"
  }, i18n2.t("intro.digital_asset.description")))), /* @__PURE__ */ React42.createElement(Box, {
    alignItems: "center",
    display: "flex",
    flexDirection: "row",
    gap: "16"
    ...
    minWidth: "48",
    width: "48"
  }, /* @__PURE__ */ React42.createElement(LoginIcon, null)), /* @__PURE__ */ React42.createElement(Box, {
    display: "flex",
    flexDirection: "column",
    gap: "4"
  }, /* @__PURE__ */ React42.createElement(Text, {
    ...
    size: "14",
    weight: "bold"
  }, i18n2.t("intro.login.title")), /* @__PURE__ */ React42.createElement(Text, {
    color: "modalTextSecondary",
    size: "14",
    weight: "medium"
  }, i18n2.t("intro.login.description"))))), /* @__PURE__ */ React42.createElement(Box, {
    alignItems: "center",
    display: "flex",
    flexDirection: "column",
    gap: "12",
    ...
    size: "14",
    weight: "bold"
  }, i18n2.t("intro.learn_more.label")))), Disclaimer && !compactModeEnabled && /* @__PURE__ */ React42.createElement(Box, {
    marginBottom: "8",
    marginTop: "12",
    textAlign: "center"
  }, /* @__PURE__ */ React42.createElement(Disclaimer, {
    Link: DisclaimerLink,
    Text: DisclaimerText
  }))));
}
...
var BackIcon = () => /* @__PURE__ */ React43.createElement("svg", {
  fill: "none",
  height: "17",
  viewBox: "0 0 11 17",
  width: "11",
...
var InfoIcon = () => /* @__PURE__ */ React44.createElement("svg", {
  fill: "none",
  height: "12",
  viewBox: "0 0 8 12",
  width: "8",
...
import React46, { useContext as useContext14, useState as useState10 } from "react";

// src/components/RainbowKitProvider/useCoolMode.ts
import { useContext as useContext13, useEffect as useEffect14, useRef as useRef4 } from "react";
var useCoolMode = (imageUrl) => {
  const ref = useRef4(null);
  const coolModeEnabled = useContext13(CoolModeContext);
...
var ModalSelection = ({
  ...
  return /* @__PURE__ */ React46.createElement(Box, {
    ...
    src: iconUrl,
    width: "28"
  }), /* @__PURE__ */ React46.createElement(Box, null, /* @__PURE__ */ React46.createElement(Box, {
    style: { marginTop: recent ? -2 : void 0 }
  }, name), recent && /* @__PURE__ */ React46.createElement(Text, {
...
import React52, { useContext as useContext15, useEffect as useEffect15 } from "react";
...
var ConnectIcon = () => /* @__PURE__ */ React47.createElement(AsyncImage, {
  background: "#515a70",
...
var CreateIcon = () => /* @__PURE__ */ React48.createElement(AsyncImage, {
  background: "#e3a5e8",
  borderColor: "generalBorder",
  borderRadius: "10",
  height: "48",
...
var RefreshIcon = () => /* @__PURE__ */ React49.createElement(AsyncImage, {
  background: "#515a70",
  borderColor: "generalBorder",
  borderRadius: "10",
  height: "48",
...
var ScanIcon = () => /* @__PURE__ */ React50.createElement(AsyncImage, {
  background: "#515a70",
  borderColor: "generalBorder",
  borderRadius: "10",
  height: "48",
...
function QRCode({
  ...
  const dots = useMemo7(() => {
    ...
    qrList.forEach(({ x, y }) => {
      ...
      for (let i = 0; i < 3; i++) {
        dots2.push(/* @__PURE__ */ React51.createElement("rect", {
        ...
        if (matrix[i][j]) {
          if (!(i < 7 && j < 7 || i > matrix.length - 8 && j < 7 || i < 7 && j > matrix.length - 8)) {
            if (!(i > matrixMiddleStart && i < matrixMiddleEnd && j > matrixMiddleStart && j < matrixMiddleEnd)) {
              dots2.push(/* @__PURE__ */ React51.createElement("circle", {
  ...
  })), /* @__PURE__ */ React51.createElement("clipPath", {
    id: "clip-logo"
  }, /* @__PURE__ */ React51.createElement("rect", {
    height: logoSize,
    width: logoSize
...
function GetDetail({
  ...
  return /* @__PURE__ */ React52.createElement(Box, {
    ...
    return /* @__PURE__ */ React52.createElement(Box, {
      ...
      size: "14",
      weight: "bold"
    }, name), /* @__PURE__ */ React52.createElement(Text, {
      color: "modalTextSecondary",
      size: "14",
      weight: "medium"
    }, hasMobileAndExtension ? i18n2.t("get.mobile_and_extension.description") : hasMobileAndDesktop ? i18n2.t("get.mobile_and_desktop.description") : hasMobileCompanionApp ? i18n2.t("get.mobile.description") : hasExtension ? i18n2.t("get.extension.description") : null))), /* @__PURE__ */ React52.createElement(Box, {
      display: "flex",
      flexDirection: "column",
      gap: "4"
    }, /* @__PURE__ */ React52.createElement(ActionButton, {
    ...
    size: "14",
    weight: "bold"
  }, i18n2.t("get.looking_for.title")), /* @__PURE__ */ React52.createElement(Text, {
    color: "modalTextSecondary",
    size: "14",
    weight: "medium"
...
function ConnectDetail({
  ...
  return /* @__PURE__ */ React52.createElement(Box, {
    ...
    height: "full",
    width: "full"
  }, hasQrCode ? /* @__PURE__ */ React52.createElement(Box, {
    alignItems: "center",
    display: "flex",
    height: "full",
    justifyContent: "center"
  }, /* @__PURE__ */ React52.createElement(QRCode, {
    ...
    wallet: name
  })), !ready && hasExtension ? /* @__PURE__ */ React52.createElement(Box, {
    paddingTop: "20"
  }, /* @__PURE__ */ React52.createElement(ActionButton, {
    href: wallet.extensionDownloadUrl,
    label: i18n2.t("connect.secondary_action.install.label"),
    type: "secondary"
  })) : null, ready && !hasQrCode && /* @__PURE__ */ React52.createElement(React52.Fragment, null, /* @__PURE__ */ React52.createElement(Box, {
    alignItems: "center",
    display: "flex",
    flexDirection: "column",
    justifyContent: "center"
    ...
    textAlign: "center",
    weight: "medium"
  }, i18n2.t("connect.status.confirm"))), /* @__PURE__ */ React52.createElement(Box, {
    alignItems: "center",
    color: "modalText",
    display: "flex",
    flexDirection: "row",
    height: "32",
    marginTop: "8"
  }, connectionError ? /* @__PURE__ */ React52.createElement(ActionButton, {
    ...
    color: "modalTextSecondary"
  }, /* @__PURE__ */ React52.createElement(SpinnerIcon, null))))))), /* @__PURE__ */ React52.createElement(Box, {
    alignItems: "center",
    borderRadius: "10",
    display: "flex",
    flexDirection: "row",
    ...
    justifyContent: "space-between",
    marginTop: "12"
  }, ready && secondaryAction && /* @__PURE__ */ React52.createElement(React52.Fragment, null, /* @__PURE__ */ React52.createElement(Text, {
    color: "modalTextSecondary",
    size: "14",
    weight: "medium"
  }, secondaryAction.description), /* @__PURE__ */ React52.createElement(ActionButton, {
...
var DownloadOptionsBox = ({
  ...
  return /* @__PURE__ */ React52.createElement(Box, {
  ...
  }), isBrowserCard && /* @__PURE__ */ React52.createElement(Box, {
    ...
    src: iconUrl,
    width: "200"
  })))), !isBrowserCard && gradientRgbas && /* @__PURE__ */ React52.createElement(Box, {
    ...
    justifyContent: "center",
    style: { zIndex: 1 }
  }, /* @__PURE__ */ React52.createElement(Box, null, /* @__PURE__ */ React52.createElement(AsyncImage, {
    height: "60",
    src: iconUrl,
    width: "60",
    ...iconBackground ? {
    ...
    size: "14",
    weight: "bold"
  }, title), /* @__PURE__ */ React52.createElement(Text, {
    color: "modalTextSecondary",
    size: "14",
    weight: "medium"
  }, description), /* @__PURE__ */ React52.createElement(Box, {
    marginTop: "14",
    width: "max"
  }, /* @__PURE__ */ React52.createElement(ActionButton, {
    href: url,
...
function DownloadOptionsDetail({
  ...
  return /* @__PURE__ */ React52.createElement(Box, {
    ...
    justifyContent: "center",
    width: "full"
  }, extensionDownloadUrl && /* @__PURE__ */ React52.createElement(DownloadOptionsBox, {
    ...
    variant: "browser"
  }), desktopDownloadUrl && /* @__PURE__ */ React52.createElement(DownloadOptionsBox, {
    ...
    variant: "desktop"
  }), mobileDownloadUrl && /* @__PURE__ */ React52.createElement(DownloadOptionsBox, {
...
function DownloadDetail({
  ...
  return /* @__PURE__ */ React52.createElement(Box, {
    ...
    size: "14",
    weight: "semibold"
  }, i18n2.t("get_mobile.description"))), /* @__PURE__ */ React52.createElement(Box, {
    height: "full"
  }, (downloadUrls == null ? void 0 : downloadUrls.qrCode) ? /* @__PURE__ */ React52.createElement(QRCode, {
    logoSize: 0,
    size: 268,
...
var stepIcons = {
  ...
  install: (wallet) => /* @__PURE__ */ React52.createElement(AsyncImage, {
...
function InstructionMobileDetail({
  ...
  return /* @__PURE__ */ React52.createElement(Box, {
    ...
    return /* @__PURE__ */ React52.createElement(Box, {
      ...
      position: "relative",
      width: "48"
    }, (_a2 = stepIcons[d.step]) == null ? void 0 : _a2.call(stepIcons, wallet)), /* @__PURE__ */ React52.createElement(Box, {
      display: "flex",
      flexDirection: "column",
      gap: "4"
    }, /* @__PURE__ */ React52.createElement(Text, {
      ...
      size: "14",
      weight: "bold"
    }, i18n2.t(d.title)), /* @__PURE__ */ React52.createElement(Text, {
      color: "modalTextSecondary",
      size: "14",
      weight: "medium"
...
function DesktopOptions({ onClose }) {
  ...
  const safari = isSafari();
  const [selectedOptionId, setSelectedOptionId] = useState11();
  const [selectedWallet, setSelectedWallet] = useState11();
  const [qrCodeUri, setQrCodeUri] = useState11();
  const hasQrCode = !!(selectedWallet == null ? void 0 : selectedWallet.qrCode) && qrCodeUri;
  const [connectionError, setConnectionError] = useState11(false);
  ...
  const [initialWalletStep, setInitialWalletStep] = useState11("NONE" /* None */);
  const [walletStep, setWalletStep] = useState11("NONE" /* None */);
  ...
  switch (walletStep) {
    case "NONE" /* None */:
      walletContent = /* @__PURE__ */ React53.createElement(ConnectModalIntro, {
    ...
    case "LEARN_COMPACT" /* LearnCompact */:
      ...
      break;
    case "GET" /* Get */:
      walletContent = /* @__PURE__ */ React53.createElement(GetDetail, {
        getWalletDownload,
        compactModeEnabled
      });
    ...
    case "CONNECT" /* Connect */:
      walletContent = selectedWallet && /* @__PURE__ */ React53.createElement(ConnectDetail, {
        changeWalletStep,
        compactModeEnabled,
        connectionError,
        onClose,
    ...
    case "DOWNLOAD_OPTIONS" /* DownloadOptions */:
      walletContent = selectedWallet && /* @__PURE__ */ React53.createElement(DownloadOptionsDetail, {
        changeWalletStep,
        wallet: selectedWallet
      });
    ...
    case "DOWNLOAD" /* Download */:
      walletContent = selectedWallet && /* @__PURE__ */ React53.createElement(DownloadDetail, {
        changeWalletStep,
        wallet: selectedWallet
      });
    ...
    case "INSTRUCTIONS_MOBILE" /* InstructionsMobile */:
      walletContent = selectedWallet && /* @__PURE__ */ React53.createElement(InstructionMobileDetail, {
    ...
    case "INSTRUCTIONS_EXTENSION" /* InstructionsExtension */:
      walletContent = selectedWallet && /* @__PURE__ */ React53.createElement(InstructionExtensionDetail, {
        wallet: selectedWallet
      });
      headerLabel = selectedWallet && i18n2.t("get_options.title", {
        wallet: compactModeEnabled ? selectedWallet.shortName || selectedWallet.name : selectedWallet.name
    ...
    case "INSTRUCTIONS_DESKTOP" /* InstructionsDesktop */:
      walletContent = selectedWallet && /* @__PURE__ */ React53.createElement(InstructionDesktopDetail, {
        connectWallet: selectWallet,
        wallet: selectedWallet
      });
      headerLabel = selectedWallet && i18n2.t("get_options.title", {
  ...
  return /* @__PURE__ */ React53.createElement(Box, {
  ...
  }, (compactModeEnabled ? walletStep === "NONE" /* None */ : true) && /* @__PURE__ */ React53.createElement(Box, {
    ...
    display: "flex",
    justifyContent: "space-between"
  }, compactModeEnabled && Disclaimer && /* @__PURE__ */ React53.createElement(Box, {
    marginLeft: "16",
    width: "28"
  }, /* @__PURE__ */ React53.createElement(InfoButton, {
  ...
  }, i18n2.t("connect.title"))), compactModeEnabled && /* @__PURE__ */ React53.createElement(Box, {
    marginRight: "16"
  }, /* @__PURE__ */ React53.createElement(CloseButton, {
    onClose
  }))), /* @__PURE__ */ React53.createElement(Box, {
    className: ScrollClassName,
    paddingBottom: "18"
  }, Object.entries(groupedWallets).map(([groupName, wallets2], index) => wallets2.length > 0 && /* @__PURE__ */ React53.createElement(Fragment2, {
    key: index
  }, groupName ? /* @__PURE__ */ React53.createElement(Box, {
    marginBottom: "8",
    marginTop: "16",
    marginX: "6"
  }, /* @__PURE__ */ React53.createElement(Text, {
    ...
    size: "14",
    weight: "bold"
  }, supportedI18nGroupNames.includes(groupName) ? i18n2.t(`connector_group.${groupName.toLowerCase()}`) : groupName)) : null, /* @__PURE__ */ React53.createElement(Box, {
    display: "flex",
    flexDirection: "column",
    gap: "4"
  }, wallets2.map((wallet) => {
    return /* @__PURE__ */ React53.createElement(ModalSelection, {
  ...
  }))))), compactModeEnabled && /* @__PURE__ */ React53.createElement(React53.Fragment, null, /* @__PURE__ */ React53.createElement(Box, {
    background: "generalBorder",
    height: "1",
    marginTop: "-1"
  }), Disclaimer ? /* @__PURE__ */ React53.createElement(Box, {
    paddingX: "24",
    paddingY: "16",
    textAlign: "center"
  }, /* @__PURE__ */ React53.createElement(Disclaimer, {
    Link: DisclaimerLink,
    Text: DisclaimerText
  })) : /* @__PURE__ */ React53.createElement(Box, {
    alignItems: "center",
    ...
    size: "14",
    weight: "medium"
  }, i18n2.t("connect.new_to_ethereum.description"))), /* @__PURE__ */ React53.createElement(Box, {
    alignItems: "center",
    display: "flex",
    flexDirection: "row",
    gap: "4",
    ...
    size: "14",
    weight: "bold"
  }, i18n2.t("connect.new_to_ethereum.learn_more.label"))))))), (compactModeEnabled ? walletStep !== "NONE" /* None */ : true) && /* @__PURE__ */ React53.createElement(React53.Fragment, null, !compactModeEnabled && /* @__PURE__ */ React53.createElement(Box, {
    background: "generalBorder",
    minWidth: "1",
    width: "1"
  }), /* @__PURE__ */ React53.createElement(Box, {
    ...
    width: "28"
  }, headerBackButtonLink && /* @__PURE__ */ React53.createElement(Box, {
    as: "button",
    className: touchableStyles({
      active: "shrinkSm",
      hover: "growLg"
    ...
    transition: "default",
    type: "button"
  }, /* @__PURE__ */ React53.createElement(BackIcon, null))), /* @__PURE__ */ React53.createElement(Box, {
    display: "flex",
    justifyContent: "center",
    style: { flexGrow: 1 }
  }, headerLabel && /* @__PURE__ */ React53.createElement(Text, {
    color: "modalText",
    size: "18",
    textAlign: "center",
    weight: "heavy"
  }, headerLabel)), /* @__PURE__ */ React53.createElement(CloseButton, {
    onClose
  })), /* @__PURE__ */ React53.createElement(Box, {
    display: "flex",
    flexDirection: "column",
...
var LoadingSpinner = ({ wallet }) => {
  ...
  return /* @__PURE__ */ React54.createElement("svg", {
    ...
    width: "86",
    height: "86"
  }, /* @__PURE__ */ React54.createElement("rect", {
    x: "3",
    y: "3",
    width,
    height,
...
function WalletButton({
  ...
  return /* @__PURE__ */ React54.createElement(Box, {
    ...
    paddingTop: "10",
    position: "relative"
  }, connecting ? /* @__PURE__ */ React54.createElement(LoadingSpinner, {
    wallet
  }) : null, /* @__PURE__ */ React54.createElement(AsyncImage, {
    background: iconBackground,
    borderRadius: "13",
    ...
    src: iconUrl,
    width: "60"
  })), !connecting ? /* @__PURE__ */ React54.createElement(Box, {
    display: "flex",
    flexDirection: "column",
    textAlign: "center"
    ...
    as: "span",
    position: "relative"
  }, shortName != null ? shortName : name, !wallet.ready && " (unsupported)")), wallet.recent && /* @__PURE__ */ React54.createElement(Text, {
    color: "accentColor",
    size: "12",
    weight: "medium"
...
function MobileOptions({ onClose }) {
  ...
  let headerBackButtonLink = null;
  const [walletStep, setWalletStep] = useState12("CONNECT" /* Connect */);
  const { i18n: i18n2 } = useContext17(I18nContext);
  const ios = isIOS();
  switch (walletStep) {
    case "CONNECT" /* Connect */: {
      ...
      walletContent = /* @__PURE__ */ React54.createElement(Box, null, /* @__PURE__ */ React54.createElement(Box, {
        background: "profileForeground",
        className: scroll,
        display: "flex",
        paddingBottom: "20",
        ...
        return /* @__PURE__ */ React54.createElement(Box, {
          ...
          width: "60"
        }, /* @__PURE__ */ React54.createElement(WalletButton, {
          onClose,
          wallet
        })));
      }))), /* @__PURE__ */ React54.createElement(Box, {
        ...
        size: "16",
        weight: "bold"
      }, i18n2.t("intro.title")), /* @__PURE__ */ React54.createElement(Text, {
        color: "modalTextSecondary",
        size: "16"
      }, i18n2.t("intro.description")))), /* @__PURE__ */ React54.createElement(Box, {
        paddingTop: "32",
        paddingX: "20"
      }, /* @__PURE__ */ React54.createElement(Box, {
        display: "flex",
    ...
    case "GET" /* Get */: {
      ...
      walletContent = /* @__PURE__ */ React54.createElement(Box, null, /* @__PURE__ */ React54.createElement(Box, {
        ...
        return /* @__PURE__ */ React54.createElement(Box, {
          ...
          size: "18",
          weight: "bold"
        }, name)), /* @__PURE__ */ React54.createElement(ActionButton, {
          ...
          size: "small",
          type: "secondary"
        })), index < mobileWallets.length - 1 && /* @__PURE__ */ React54.createElement(Box, {
          background: "generalBorderDim",
          height: "1",
          marginY: "10",
          width: "full"
  ...
  return /* @__PURE__ */ React54.createElement(Box, {
    ...
    size: "20",
    weight: "bold"
  }, headerLabel)), /* @__PURE__ */ React54.createElement(Box, {
    alignItems: "center",
    display: "flex",
    height: "32",
    paddingRight: "14",
...
function ConnectOptions({ onClose }) {
  ...
  return isMobile() ? connector ? /* @__PURE__ */ React56.createElement(MobileStatus, {
    onClose
  }) : /* @__PURE__ */ React56.createElement(MobileOptions, {
    onClose
  }) : /* @__PURE__ */ React56.createElement(DesktopOptions, {
    onClose
  });
}
...
function ConnectModal({ onClose, open }) {
  ...
  if (connectionStatus === "disconnected") {
    return /* @__PURE__ */ React57.createElement(Dialog, {
      onClose: onConnectModalCancel,
      open,
      titleId
    }, /* @__PURE__ */ React57.createElement(DialogContent, {
      bottomSheetOnMobile: true,
      padding: "0",
      wide: true
    }, /* @__PURE__ */ React57.createElement(ConnectOptions, {
      onClose: onConnectModalCancel
    })));
  }
  if (connectionStatus === "unauthenticated") {
    return /* @__PURE__ */ React57.createElement(Dialog, {
      ...
      bottomSheetOnMobile: true,
      padding: "0"
    }, /* @__PURE__ */ React57.createElement(SignIn, {
      onClose: onAuthCancel
    })));
  }
  return null;
...
function ModalProvider({ children }) {
  ...
  return /* @__PURE__ */ React58.createElement(ModalContext.Provider, {
    value: useMemo8(() => ({
      accountModalOpen,
      chainModalOpen,
      connectModalOpen,
  ...
  }, children, /* @__PURE__ */ React58.createElement(ConnectModal, {
    onClose: closeConnectModal,
    open: connectModalOpen
  }), /* @__PURE__ */ React58.createElement(AccountModal, {
    onClose: closeAccountModal,
    open: accountModalOpen
  }), /* @__PURE__ */ React58.createElement(ChainModal, {
...
function ConnectButton({
  ...
  return /* @__PURE__ */ React60.createElement(ConnectButtonRenderer, null, ({
    account,
    chain,
    mounted,
    openAccountModal,
    ...
    return /* @__PURE__ */ React60.createElement(Box, {
      display: "flex",
      gap: "12",
      ...!ready && {
        "aria-hidden": true,
    ...
    }, ready && account && connectionStatus === "connected" ? /* @__PURE__ */ React60.createElement(React60.Fragment, null, chain && (chains.length > 1 || unsupportedChain) && /* @__PURE__ */ React60.createElement(Box, {
      alignItems: "center",
      ...
      transition: "default",
      type: "button"
    }, unsupportedChain ? /* @__PURE__ */ React60.createElement(Box, {
      alignItems: "center",
      display: "flex",
      height: "24",
      paddingX: "4"
    }, "Wrong network") : /* @__PURE__ */ React60.createElement(Box, {
      alignItems: "center",
      display: "flex",
      gap: "6"
    }, chain.hasIcon ? /* @__PURE__ */ React60.createElement(Box, {
      display: mapResponsiveValue(chainStatus, (value) => value === "full" || value === "icon" ? "block" : "none"),
      height: "24",
      width: "24"
    }, /* @__PURE__ */ React60.createElement(AsyncImage, {
      ...
      src: chain.iconUrl,
      width: "24"
    })) : null, /* @__PURE__ */ React60.createElement(Box, {
    ...
    }, (_c = chain.name) != null ? _c : chain.id)), /* @__PURE__ */ React60.createElement(DropdownIcon, null)), !unsupportedChain && /* @__PURE__ */ React60.createElement(Box, {
      alignItems: "center",
      as: "button",
      ...
      transition: "default",
      type: "button"
    }, account.displayBalance && /* @__PURE__ */ React60.createElement(Box, {
      ...
      paddingY: "6",
      transition: "default"
    }, /* @__PURE__ */ React60.createElement(Box, {
      alignItems: "center",
      display: "flex",
      gap: "6",
      height: "24"
    ...
    }, /* @__PURE__ */ React60.createElement(Avatar, {
    ...
    }, account.displayName), /* @__PURE__ */ React60.createElement(DropdownIcon, null)))))) : /* @__PURE__ */ React60.createElement(Box, {
      as: "button",
      background: "accentColor",
      borderRadius: "connectButton",
      boxShadow: "connectButton",
...
function WalletButtonRenderer({
  ...
  const { isConnected, isConnecting } = useAccount13({
    onConnect: () => {
      if (isError)
        setIsError(false);
    },
...
var WalletButton2 = ({ wallet }) => {
  return /* @__PURE__ */ React62.createElement(WalletButtonRenderer, {
    wallet
    ...
    return /* @__PURE__ */ React62.createElement(Box, {
      ...
      gap: "12",
      paddingRight: "6"
    }, /* @__PURE__ */ React62.createElement(Box, null, loading ? /* @__PURE__ */ React62.createElement(SpinnerIcon, null) : /* @__PURE__ */ React62.createElement(AsyncImage, {
      ...
      wallet: connectorName
    }) : connectorName)), connected ? /* @__PURE__ */ React62.createElement(Box, {
      background: "connectionIndicator",
      borderColor: "selectedOptionBorder",
      borderRadius: "full",
      borderStyle: "solid",
